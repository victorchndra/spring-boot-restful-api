...
class ContactControllerTest {
    ...
    @Test
    void searchNotFound() throws Exception { //search data tapi data tidak ada
        mockMvc.perform(
                get("/api/contacts")
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void searchSuccess() throws Exception {
        ...
        mockMvc.perform(
            ...
            assertNull(response.getErrors());
            assertEquals(10, response.getData().size()); //per page nya ada 10 data
            assertEquals(10, response.getPaging().getTotalPage()); // 100 data yang ketemu dibagi 10 size per page
            assertEquals(0, response.getPaging().getCurrentPage());
            assertEquals(10, response.getPaging().getSize());
        });
        ...
        mockMvc.perform(
            ...
            assertNull(response.getErrors());
            assertEquals(0, response.getData().size()); //per page nya ada 10 data
            assertEquals(10, response.getPaging().getTotalPage()); // 100 data yang ketemu dibagi 10 size per page
